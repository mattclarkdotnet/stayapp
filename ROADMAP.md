...
1. Separate spaces setting pauses Stay
...
4. Code cleanup and baseline hardening
...
5. Full-cycle sleep/wake scenario automation (wake-only human intervention)
