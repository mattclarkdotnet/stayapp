...
2. Changes in monitor configuration while the system is awake
...
3. Separate spaces setting pauses Stay
...
6. Code cleanup and baseline hardening
...
7. Full-cycle sleep/wake scenario automation (wake-only human intervention)
